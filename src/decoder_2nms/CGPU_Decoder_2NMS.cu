...
CGPU_Decoder_2NMS::~CGPU_Decoder_2NMS()
{

}

void CGPU_Decoder_2NMS::initialize()
{

}

void CGPU_Decoder_2NMS::decode(float Intrinsic_fix[_N], int Rprime_fix[_N], int nombre_iterations)
{
    cudaError_t Status;
