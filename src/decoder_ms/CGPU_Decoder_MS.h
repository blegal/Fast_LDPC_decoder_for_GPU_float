...
#include "./cuda/CUDA_MS.h"

class CGPU_Decoder_MS : public CGPUDecoder{
/*
private:
    float* host_V;
    float* device_V;
...
//    CHScheduledGpuDecoder();
	CGPU_Decoder_MS(int _nb_frames, int block_size, unsigned int n, unsigned int k, unsigned int m );
    ~CGPU_Decoder_MS();
    void initialize();
