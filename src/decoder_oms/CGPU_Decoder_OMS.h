...
#include "./cuda/CUDA_OMS.h"

class CGPU_Decoder_OMS : public CGPUDecoder{
/*
private:
    float* host_V;
    float* device_V;
...
//    CHScheduledGpuDecoder();
	CGPU_Decoder_OMS(int _nb_frames, int block_size, unsigned int n, unsigned int k, unsigned int m );
    ~CGPU_Decoder_OMS();
    void initialize();
