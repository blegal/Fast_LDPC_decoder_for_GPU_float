...
#define N                    1200 // Nombre de Variables
#define K                    600 // Nombre de Checks   
#define ONE_COUNT            4818 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 9
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   50
#define TAILLE_RAM_PNODE     19392 // = taille ram interleaver
#define TAILLE_VALID_RAM     1200
#define NB_CYCLE_EXEC        99
