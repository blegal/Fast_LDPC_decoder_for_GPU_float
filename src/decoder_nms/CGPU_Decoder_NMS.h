...
#include "./cuda/CUDA_NMS.h"

class CGPU_Decoder_NMS : public CGPUDecoder{
/*
private:
    float* host_V;
    float* device_V;
...
*/
public:
	CGPU_Decoder_NMS(int _nb_frames, int block_size, unsigned int n, unsigned int k, unsigned int m );
    ~CGPU_Decoder_NMS();
    void initialize();
