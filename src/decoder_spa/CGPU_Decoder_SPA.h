...
#include "./cuda/CUDA_SPA.h"

class CGPU_Decoder_SPA : public CGPUDecoder{
/*
private:
    float* host_V;
    float* device_V;
...
//    CHScheduledGpuDecoder();
	CGPU_Decoder_SPA(int _nb_frames, int block_size, unsigned int n, unsigned int k, unsigned int m );
    ~CGPU_Decoder_SPA();
    void initialize();
